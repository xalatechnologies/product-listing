...
- [ ] Aim for 80%+ coverage on critical paths (requires more tests)
- [ ] Review coverage report (can run with `npm run test:coverage`)
- [ ] Add tests for uncovered areas (requires running coverage and identifying gaps)
- [ ] Verify coverage meets target (requires running coverage report)
